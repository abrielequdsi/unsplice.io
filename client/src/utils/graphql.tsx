  ...
  mutation Register(
    ...
    createUser(
      registerInput: {
        ...
        role: $role
        picture: $picture
        socialLinks: { instagram: $instagram, github: $github, linkedin: $linkedin, website: $website }
...
export const CREATE_MODULE = gql`
  mutation NewModule($name: String!, $moduleCode: String!, $desc: String!, $programId: ID!) {
    createModule(moduleInput: { programId: $programId, name: $name, moduleCode: $moduleCode, desc: $desc }) {
      #Get User Info
      name
      moduleCode
      desc
...
export const CREATE_CONTENT = gql`
  mutation NewContent($moduleId: ID!, $number: Int!, $title: String!, $desc: String!, $notionContent: String!) {
    createContent(
      contentInput: { moduleId: $moduleId, number: $number, title: $title, desc: $desc, notionContent: $notionContent }
    ) {
      #Get User Info
      number
      title
